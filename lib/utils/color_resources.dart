...
class ColorResources {
  ...
  static const Color COLOR_PRIMARY = Color.fromRGBO(244, 214, 0, 1);
  ...
  static const Color DARK_BLUE = Color(0xFF001C63);
  static const Color themecolor = Color(0xFF2C5F6B);
  static const Color britnyblue = Color(0xFF4E7A86);
  ...
  static const MaterialColor PRIMARY_MATERIAL =
      MaterialColor(0xFFFFD600, colorMap);
}
